...
echo "Funcionari@ $joao->nome é $joao->tipoFuncionario e o valor de desconto é: $joao->descontos.<br>";
echo "Funcionari@ $maria->nome é $maria->tipoFuncionario e o valor de desconto é: $maria->descontos.<br>";
echo "Funcionari@ $jose->nome é $jose->tipoFuncionario e o valor de desconto é: $jose->descontos.<br>";